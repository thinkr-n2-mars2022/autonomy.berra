...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Check the integrity of datasets",
    Description = "This package reads a dataset like nyc_squirrels and check its integrity.",
    `Authors@R` = c(
      person("Berra", "Erkosar", email = "berra.erkosar@finddx.org", role = c("aut", "cre"), comment = c(ORCID = "0000-0002-1565-9313")),
